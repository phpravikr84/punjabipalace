...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2025 at 01:30 PM
...
(11, 'Starters', NULL, 1, NULL, 1, '2025-01-09 02:19:16', '2025-01-09 02:19:16');
...
(10, 11, 'Veg', NULL, 'Veg', 1, '2025-01-09 04:03:40', '2025-01-09 04:03:40'),
(11, 11, 'Non-Veg', NULL, 'Non Vegetarian', 1, '2025-01-09 04:04:11', '2025-01-09 04:04:11');
...
INSERT INTO `menu_items` (`id`, `name`, `description`, `price`, `is_bom`, `stock_id`, `menu_type`, `category_id`, `menu_id`, `created_at`, `updated_at`) VALUES
(4, 'Onion Bhaji Pakora', 'Sliced onion fritter dipped in chickpea batter with spices & gently fried.', '9.95', 0, NULL, 'Dine_In', 11, 10, '2025-01-09 04:46:35', '2025-01-09 04:46:35');
...
--
ALTER TABLE `vendor_payments`
  ADD CONSTRAINT `vendor_payments_purchase_order_id_foreign` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_orders_old` (`id`) ON DELETE CASCADE;
COMMIT;
