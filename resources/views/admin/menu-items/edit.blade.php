...
<div class="container">
    <div class="card">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="link" id="link" class="form-control" value="{{ $menuItem->link }}" required>
            @error('link')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="order" id="order" class="form-control" value="{{ $menuItem->order }}" required>
            @error('order')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <a href="{{ route('menu_items.index', ['menu_id' => $menuItem->menu_id]) }}" class="btn btn-secondary">Cancel</a>
    </form>
        </div>
    </div>
</div>
